...
namespace LINQ.Exercises
{
    ...
    public class Restriction
    {
        ...
        {
            IEnumerable<int> result = TestData.Numbers.Where(n => (n % 2).Equals(0));
        ...
        {
            IEnumerable<int> result = TestData.Numbers.Select((item, index) => new { Item = item, Index = index }).Where(o => o.Index % 2 == 0).Select(o => o.Item);
